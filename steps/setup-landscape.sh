...
landscape-api register-maas-region-controller --json endpoint="http://$MAAS_ENDPOINT/MAAS/" credentials="$MAAS_APIKEY" --uri https://$HAPROXY/api/ --ssl-ca-file /etc/ssl/certs/landscape_server_ca.crt > /dev/null 2>&1
